# nvim-treesitter-queries-tiger

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-tiger/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-tiger/actions/workflows/validate.yml)

Neovim tree-sitter queries for **tiger**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-tiger",
...
- [ ] Changes are scoped to `tiger` — do not include files for other languages
